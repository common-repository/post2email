...
= Version 1.3.1 =
* 29 June 2016 by Ipstenu
* Fixing parameters

= Version 1.3 =
* 09 March 2016 by Ipstenu
* Removed WP 3.5 and older check. It's time.
* Corrected Internationalization
* More robust checking on when not to send email (like not if your 'to' email is still default)
* Stop calling deprecated functions.
